...
void createSet(unordered_set<string>& spam,string& str);
// input: set,string for file input
// output: returns nothing but fills set
void checkSpam(unordered_set<string>& spam,string& str,int& goodcount,int& spamcount);
// input: set,string for file input, 2 ints
// output: returns nothing but increments correct IP and bad IP
void rmvSpam(unordered_set<string>& spam,string& str,int& rmvcount);
...
void display(unordered_set<string>& spam, int& gcount, int& spamcount,int& rmvcount,clock_t& ticks);
//input: set, 4 ints
//output: none
