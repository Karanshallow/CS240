...
void displayMenu(string& str){
  ...
  cout<<"2. How many members are in the circle of friends?"<<endl;
...
void Choice4(Circle& circle){
  string input;
  cout<<"Enter name1 here(Exact spelling matters):"<<endl;
  cin>>input;
...
void Choice6(Circle& circle){
  ...
  cin>>input;
  string sinput;
  cout<<"Enter name2 here(Exact spelling matters):"<<endl;
  cin>>sinput;
